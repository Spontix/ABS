...
public class CustomerController extends HelperFunction implements Initializable{
        ...
        try {
            ...
            if(loansSupportInlay.isEmpty()){
                ...
                doneChosenLoanButton.setOnAction(e->{
                    doneChosenLoanButtonSetOnAction(dtoInlay,investAmount,maximumLoanOwnershipPercentage);
                });
    ...
    private void doneChosenLoanButtonSetOnAction(DTOInlay dtoInlay, int investAmount, int maximumLoanOwnershipPercentage){
        ...
        try {
            ...
            mySetVisible(false);
            popupMessage("Success!",dtoMovementList.toString());
